...
System.out.println("In this program, the accessibility of static and non-static methods inside a class is shown.");
...
obj.divide(re1, im1, re2, im2); //accessing a non-static method; object is required
}
}
